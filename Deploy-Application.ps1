...
Try {
	...
	[string]$appScriptDate = '02/04/2021'
	[string]$appScriptAuthor = 'James Hardy & Steve Patterson'
	##*===============================================
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		Show-InstallationWelcome -CloseApps 'bomgar-scc' -CheckDiskSpace -PersistPrompt
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Show-InstallationWelcome -CloseApps 'bomgar-scc' -CloseAppsCountdown 60
		...
		$exitCode = Execute-MSI -Action 'Uninstall' -Path '{AF334156-0209-43D1-968F-7220F9A3D082}' -Parameters '/qn' -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
